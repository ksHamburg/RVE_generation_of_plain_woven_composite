...
import shutil
import numpy as np
import mesh_lib_ABQ2024 as mesh_lib
################################################################################
# INPUT PARAMETERS
################################################################################
# ABAQUS-PATH
...
# MESHING PARAMETERS
mesh_densities_matrix       = [0.09 ,0.07,0.07 ,0.07 ,0.07  ]
mesh_densities_yarn_ellipse = [0.055,0.06,0.035,0.035,0.035 ]
mesh_densities_yarn_inside  = [0.065,0.08,0.04 ,0.04 ,0.04  ]
quad_ele    = True
ele_ord_str = 'QUAD'
# MATERIAL DATA
isotropy_flag   = True
...
################################################################################
################################################################################
cmd     = abq_path+' cae noGUI=gen_plain_woven_RVE_in_abq_ABQ2024.py -- "'

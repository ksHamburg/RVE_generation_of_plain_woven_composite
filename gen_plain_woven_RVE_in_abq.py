...
for i in xrange(len(unitcell.cells)):
...
for i in xrange(len(unitcell.cells)):
    ...
    if not len(Dic_Flaechen_in_x0[str(i)]) == 0:                                                                    # ohne diese Abfrage Fehlermeldung: list index out of range
        ...
        elem_x1 = MeshElemFaceArray(Elem_x1)                                                                        # elemFaces in associateMeshWithGeometry akzeptiert nur Datentyp MeshElementFaceArray oder Sets. Sets aus Elemfaces nicht erstellbar
    ...
    if not len(Dic_Flaechen_in_y0[str(i)]) == 0:
        ...
        elem_y1 = MeshElemFaceArray(Elem_y1)                                                                        # elemFaces in associateMeshWithGeometry akzeptiert nur Datentyp MeshElementFaceArray oder Sets. Sets aus Elemfaces nicht erstellbar
    ...
    if not len(Dic_Flaechen_in_z0[str(i)]) == 0:
        ...
        elem_z1 = MeshElemFaceArray(Elem_z1)                                                                        # elemFaces in associateMeshWithGeometry akzeptiert nur Datentyp MeshElementFaceArray oder Sets. Sets aus Elemfaces nicht erstellbar
